...
if __name__ == '__main__':
    ...
    rules = set()
    start = time.time()
    check_property_refining(target_rule, rules, complete_rules , ACTION, state_action, True, min_solution=mymin, final_min_solution=True,
                            vol_bound=bound, restart=restart, boundary_case = bcr, universal_blocking=ub)
