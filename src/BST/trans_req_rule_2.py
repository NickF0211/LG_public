...
rule_4 = forall(Trans, lambda trans: Sum(Trans, lambda trans1: trans1.amount, lambda trans1: EQ(trans1.cid, trans.cid)) < 2* 100)
...
if __name__ == '__main__':
    ...
    rules = set()
    start = time.time()
    check_property_refining(NOT(rule_4), rules, complete_rules, ACTION, state_action, True, min_solution=mymin, final_min_solution=True, vol_bound = 1000)
