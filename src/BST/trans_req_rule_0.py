...
if __name__ == '__main__':
    ...
    rules = set()
    start = time.time()
    check_property_refining(rule_2, rules, complete_rules, ACTION, state_action, True, vol_bound = 10, min_solution=mymin, final_min_solution=True, restart=restart, boundary_case = bcr, universal_blocking=ub)
