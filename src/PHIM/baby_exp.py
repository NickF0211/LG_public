...
def run_exp(command_header):
    ...
    for i in range(3):
        ...
        for j in range(1,18):
            ...
            result_file = "results/baby_{}_rule_opt_{}_restart.txt".format(i, j)
            print(result_file)
            with open(result_file, 'w') as f:
                try:
            ...
            result_file = "results/baby_{}_rule_opt_{}_bcr.txt".format(i, j)
            print(result_file)
            with open(result_file, 'w') as f:
                try:
            ...
            result_file = "results/baby_{}_rule_opt_{}_ub.txt".format(i, j)
            print(result_file)
            with open(result_file, 'w') as f:
                try:
            ...
            result_file = "results/baby_{}_rule_opt_{}_all.txt".format(i, j)
            print(result_file)
            with open(result_file, 'w') as f:
                try:
    ...
    for j in range(1, 18):
        ...
        result_file = "results/baby_unbounded_rule_opt_{}_restart.txt".format(j)
        print(result_file)
        with open(result_file, 'w') as f:
            try:
        ...
        result_file = "results/baby_unbounded_rule_opt_{}_bcr.txt".format(j)
        print(result_file)
        with open(result_file, 'w') as f:
            try:
        ...
        result_file = "results/baby_unbounded_rule_opt_{}_ub.txt".format(j)
        print(result_file)
        with open(result_file, 'w') as f:
            try:
                result = subprocess.run(command_header + [rule_file, "t", "f", "f", "t"], stdout=subprocess.PIPE,
        ...
        result_file = "results/baby_unbounded_rule_opt_{}_all.txt".format(j)
        print(result_file)
        with open(result_file, 'w') as f:
            try:
                result = subprocess.run(command_header + [rule_file, "t", "t", "t", "t"], stdout=subprocess.PIPE,
