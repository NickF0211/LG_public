...
max_pid = 5
type_dict = dict()
time = create_type("time", type_dict, lower_bound=0, upper_bound= 5000 )
sid = create_type("sid", type_dict, lower_bound = 0, upper_bound = 2)
aid = create_type("aid", type_dict, lower_bound = 0, upper_bound = 2)
